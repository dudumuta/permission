package com.vdian.flutter.plugin.permission
...
import com.vdian.flutter.plugin.permission.utils.Codec
...
class PermissionPlugin(private val registrar: Registrar, private var requestedPermissions: MutableList<String>? = null) : MethodCallHandler {
    ...
    companion object {
        ...
        @JvmStatic
        private val mLogTag = "permissions"

        @JvmStatic
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "com.vdian.flutter.plugin.permission/methods")
            val instance = PermissionPlugin(registrar)
